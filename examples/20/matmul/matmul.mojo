...
fn run_matmul_python(M: Int, N: Int, K: Int) -> Float64:
    ...
    try:
        ...
        let pymatmul_module: PythonObject = Python.import_module("matmul")  # matmul.py
        if pymatmul_module:
            gflops = pymatmul_module.benchmark_matmul_python(M, N, K).to_float64()
        else:
